...
Am=input('Enter the amplitude of modulating signal(Am) = '); % Amplitude of modulating signal
fa=input('Enter the frequency of modulating signal(fa) = '); % Frequency of modulating signal
...
fc=input('Enter the frequency of carrier signal(fc) = ');% Frequency of carrier signal
